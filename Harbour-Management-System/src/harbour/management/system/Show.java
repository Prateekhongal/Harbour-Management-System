...
public class Show extends JFrame{  //Second Frame
	...
	JLabel Scode = new JLabel("CANCELLATION NO");
	...
	JLabel ShipDetails = new JLabel("CANCELLED BOOKINGS");
	...
	btnShow.setFont(new Font("Tahoma", Font.PLAIN, 20));
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "select pnr_no,cancellation_no,cancellation_date,Ship_code from cancellation  where cancellation_no = '"+code+"'";
