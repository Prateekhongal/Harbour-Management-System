...
public class Add_Customer extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public Add_Customer(){
            ...
            JLabel Shipcode = new JLabel("SHIP CODE");
            Shipcode.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Shipcode.setBounds(60, 30, 150, 27);
            add(Shipcode);
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("harbour/management/system/icon/emp.png"));
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    String ship_code = textField_6.getText();
                    ...
                    try {
                        conn c = new conn();
                        String str = "INSERT INTO passenger values( '"+pnr_no+"', '"+address+"', '"+nationality+"','"+name+"', '"+gender+"', '"+ph_no+"','"+passport_No+"', '"+ship_code+"')";
