...
public class Cancel extends JFrame { //Sixth
	...
	add(Cancellation);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("harbour/management/system/icon/cancel.png"));
	...
	JLabel Shipcode = new JLabel("SHIP_CODE");
	Shipcode.setFont(new Font("Tahoma", Font.PLAIN, 17));
	Shipcode.setBounds(60, 300, 150, 27);
	add(Shipcode);
	...
	add(textField_4);
		...
		String ship_code = textField_4.getText();
					
					
		try{	
                    conn c = new conn();
                    String str = "INSERT INTO cancellation values('"+passenger_no+"', '"+cancellation_no+"', '"+cancellation_date+"', '"+ticket_id+"', '"+ship_code+"')";
