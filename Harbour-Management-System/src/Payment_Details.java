...
public class Payment_Details extends JFrame{ //Fifth
    ...
    JTable table;
    JLabel Sector;
    JLabel ShipCode, Capacity, Classcode, Classname, label;
	...
	ShipCode = new JLabel("PNR_NO");
	ShipCode.setFont(new Font("Tahoma", Font.PLAIN, 13));
	ShipCode.setBounds(84, 292, 108, 26);
	add(ShipCode);
	...
	label = new JLabel("");
	label.setIcon(new ImageIcon(ClassLoader.getSystemResource("harbour/management/system/icon/payment.png")));
